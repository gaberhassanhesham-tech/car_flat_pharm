#!/usr/bin/env pwsh
# Setup Deploy Key for car_flat_pharm Project
...
$sshLocalPath = "$env:USERPROFILE\.ssh_local\car_flat_pharm"

function Show-Help {
    Write-Host @"
Deploy Key Setup Script for car_flat_pharm
...
function Setup-DeployKey {
    ...
    if ($currentRepo -like "*http*") {
        ...
        Write-Host "New URL: git@github.com-car_flat_pharm:gaberhassanhesham-tech/car_flat_pharm.git"
...
function Test-DeployKey {
    ...
    ssh -T git@github.com-car_flat_pharm 2>&1
