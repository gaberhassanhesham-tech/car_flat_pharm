@echo off
REM Deploy Key Setup Script for car_flat_pharm
...
set "sshLocalPath=%USERPROFILE%\.ssh_local\car_flat_pharm"

echo.
echo ========================================
echo Deploy Key Setup - car_flat_pharm
echo ========================================
echo.
...
echo       https://github.com/gaberhassanhesham-tech/car_flat_pharm/settings/keys
